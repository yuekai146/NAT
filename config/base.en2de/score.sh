...
python3 translate.py -ckpt checkpoints/checkpoint_best_ppl.pth -text ~/test_2016/test.en -ref_text ~/test_2016/test.de --max_batch_size 0 --tokens_per_batch 2000 -max_len 200 --nat > total.out
